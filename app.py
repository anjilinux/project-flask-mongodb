...
# MONGO DB Connection
client = MongoClient("mongodb+srv://Shubham:Shubham123@cluster0.k8b4o.mongodb.net/Final_Project?ssl=true&ssl_cert_reqs=CERT_NONE")
...
# Scheduled process to update db every 24 hours
